...
export const BOT_TIERS: Readonly<Record<1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 | 9, BotTier>> = {
  ...
  3: { normal: 40,  power: 4,   temperature: 0.5, policy: { precision: 0.6, horizon: 0, modelStrength: 0    } },
  4: { normal: 60,  power: 8,   temperature: 0.5, policy: { precision: 1.0, horizon: 0, modelStrength: 0.25 } },
  5: { normal: 90,  power: 15,  temperature: 0.5, policy: { precision: 1.5, horizon: 1, modelStrength: 0.5  } },
  6: { normal: 180, power: 30,  temperature: 0.6, policy: { precision: 2.5, horizon: 1, modelStrength: 0.75 } },
  7: { normal: 180, power: 60,  temperature: 0.5, policy: { precision: 4.0, horizon: 2, modelStrength: 1    } },
  8: { normal: 250, power: 80,  temperature: 0.5, policy: { precision: 8.0, horizon: 2, modelStrength: 1    } },
  9: { normal: 320, power: 100, temperature: 0.5, policy: { precision: Infinity, horizon: 3, modelStrength: 1 } },
}
