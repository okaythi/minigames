...
export type SfxName = 'flap' | 'bounce' | 'candy' | 'death' | 'start' | 'ui' | 'powerup'
...
export const SFX: Readonly<Record<SfxName, SoundDesign>> = {
  ...
  powerup: {
    voices: [
      { kind: 'square', from: 400, to: 1200, delay: 0, duration: 0.15, gain: 0.08, curve: 'lin' },
      { kind: 'sawtooth', from: 300, to: 900, delay: 0, duration: 0.15, gain: 0.06, curve: 'lin' },
    ],
  },
}
